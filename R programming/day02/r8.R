...
#------------------------------------
df.seattle_crime <- read.csv("2016death.csv")
...
# SEATTLE GGMAP
################
map.seattle_city <- qmap("seoul", zoom = 11, source="google", maptype="roadmap")
map.seattle_city
...
map.seattle_city +
  geom_point(data=df.seattle_crime, aes(x=Longitude, y=Latitude), color="#ffaa00", alpha=.03, size=1.1)
