...
<%! int number=0; %>
	...
	<div class="content-wrapper">
		...
		<div class='row'>
			<div class='col-sm-4'>
				<div class="container-fluid">
					...
					<div class="card mb-1">
						...
						<div>
							<img name="img4" src="view/arrows.png" onclick="location.href='http://70.12.114.147/ws/paging.do?num=<%=number+=5%>'" style="height: 30px; margin-left: auto; margin-right: auto; max-height: 10%; max-width: 10%;">
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="GaugeMeter" id="PreviewGaugeMeter_3"
								data-percent="36"
								data-text="<font style='color:#2980B9;font-size:29px;letter-spacing:-1px'>36</font>"
						...
						<div class="col-sm-6">
							<div class="GaugeMeter" id="PreviewGaugeMeter_4"
								data-percent="86" data-append="Day" data-size="130"
								data-theme="black" data-back="RGBa(0,0,0,.1)"
								data-animate_gauge_colors="1" data-animate_text_colors="1"
								data-width="15" data-label="무상점검" data-label_color="#2980B9"
								data-stripe="2"></div>
						</div>
			...
			<div class='col-sm-5'>
					...
					<div class="col-xl-4 col-sm-6 mb-4">
						<div class="card text-white bg-warning o-hidden h-100">
							<div class="card-body" onclick="ChangeDust()">
								<div class="text-center">
									<B><font size="1.5">미세먼지: 50㎍/㎥ <BR> 초미세먼지:
											12㎍/㎥
									</font></B>
								</div>
							</div>
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#">가장 가까운 충전소</a></li>
					<li class="breadcrumb-item active">위치 정보</li>
				</ol>
	...
	<script
		src="https://code.highcharts.com/modules/parallel-coordinates.js"></script>
